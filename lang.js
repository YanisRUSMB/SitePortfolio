const translations = {
  fr: {
    ...
    "project.tropic.role": "Artiste & Dev Gameplay",
    "project.tropic.team": "3 personnes",
    "project.tropic.duration": "Game Jam (Thème : TROPICAL)",
    "project.tropic.context": "Réalisé lors d'une Game Jam sur le thème \"TROPICAL\". Nous avions 3 contraintes à respecter : inclure un système de score façon arcade, avoir une fin inattendue, et intégrer des quêtes. Suite à des complications dans l'équipe, j'ai dû assumer en grande partie le rôle d'artiste, en plus du développement gameplay.",
    "project.tropic.c1": "Création d'une grande partie des assets artistiques du jeu.",
    "project.tropic.c2": "Implémentation du système d'inventaire.",
    "project.tropic.c3": "Gestion des sons d'ambiance et des effets sonores du personnage.",
    "project.tropic.c4": "Réalisation des différentes cinématiques du jeu.",

    "project.bloody.role": "Développeur Gameplay",
    "project.bloody.team": "6 personnes",
    "project.bloody.duration": "Première Game Jam",
    "project.bloody.context": "Ce jeu a été développé lors de ma toute première Game Jam. L'histoire suit plusieurs personnes enfermées dans un labyrinthe, qui doivent survivre et finalement se battre entre elles à la fin pour déterminer qui pourra ressortir vivant.",
    "project.bloody.c1": "Programmation de la gestion des dégâts et de la vie entre les joueurs et les ennemis.",
    "project.bloody.c2": "Implémentation du système de collecte (loot) des objets dans le donjon.",
    "project.bloody.c3": "Développement de multiples vérifications de gameplay pour solidifier la boucle de jeu globale.",

    "project.rumble.role": "Développeur Gameplay",
    "project.rumble.team": "Non précisé",
    "project.rumble.duration": "WonderJam d'hiver 2025",
    "project.rumble.context": "On y joue un frère et une sœur qui se battent avec leurs jouets pour prendre le contrôle de la chambre. Projet réalisé lors de la WonderJam d'hiver 2025 sur le thème \"Frontières\". Nous devions respecter 3 contraintes de style : \"Un point pour moi\" (Genre Arcade), \"Survivre un autre jour\" (Élément Survival), et \"Mon..Ami?\" (Ton allié est aussi ton ennemi).",
    "project.rumble.c1": "Développement du gameplay pour les 2 joueurs.",
    "project.rumble.c2": "Programmation des mécaniques de \"World Event\" affectant la partie.",

    "project.critter.role": "Développeur",
    "project.critter.team": "16 personnes",
    "project.critter.duration": "Projet de fin de Baccalauréat (Atelier Jeu Vidéo)",
    "project.critter.context": "Incarnez un écureuil prêt à tout pour protéger sa précieuse noisette d'une horde de monstres affamés... Projet réalisé lors de mon dernier semestre de baccalauréat en développement de jeux vidéo (UQAC), dans le cadre du cours d'Atelier Jeu Vidéo. Nous avons collaboré avec le NAD (école d'art affiliée à l'UQAC) avec une équipe totale de 16 personnes.",
    "project.critter.c1": "Développement des déplacements de la mouffette.",
    "project.critter.c2": "Débuggage des mouvements et de diverses fonctionnalités, notamment le système de rail.",
    "project.critter.c3": "Création de la mécanique de trace.",
    "project.critter.c4": "Implémentation du système de santé de la nourriture.",

    "project.stake.role": "Game Designer & Support",
    "project.stake.team": "7 personnes",
    "project.stake.duration": "WonderJam d'automne (Thème : CONTREFAÇON)",
    "project.stake.context": "One Last Stake a été réalisé lors de la WonderJam d'automne sur le thème \"CONTREFAÇON\". Le jeu est un mélange de jeu de cartes inspiré de la bataille classique, intégré dans une structure rogue-lite. Nous avions 3 styles imposés à respecter : Nouvelle Perspective, Recommence...Encore... (élément Rogue Lite), et Cartes sur table.",
    "project.stake.c1": "Rôle de Game Designer et support au sein de l'équipe.",
    "project.stake.c2": "Création et design des différents effets de cartes.",
    "project.stake.c3": "Aide sur le Game Design de la boucle de jeu et l'équilibrage.",
  ...
  en: {
    ...
    // === Individual Projects (Titles & Context) ===
    "project.tropic.role": "Artist & Gameplay Dev",
    "project.tropic.team": "3 people",
    "project.tropic.duration": "Game Jam (Theme: TROPICAL)",
    "project.tropic.context": "Created during a Game Jam with the theme \"TROPICAL\". We had 3 constraints: include an arcade-style scoring system, have an unexpected ending, and integrate quests. Due to complications in the team, I had to take on a large part of the artist role, in addition to gameplay development.",
    "project.tropic.c1": "Creation of a large part of the game's artistic assets.",
    "project.tropic.c2": "Implementation of the inventory system.",
    "project.tropic.c3": "Management of ambient sounds and character sound effects.",
    "project.tropic.c4": "Direction of the various cutscenes in the game.",

    "project.bloody.role": "Gameplay Developer",
    "project.bloody.team": "6 people",
    "project.bloody.duration": "First Game Jam",
    "project.bloody.context": "This game was developed during my very first Game Jam. The story follows several people trapped in a labyrinth, who must survive and ultimately fight each other at the end to determine who can get out alive.",
    "project.bloody.c1": "Programming the damage and health management between players and enemies.",
    "project.bloody.c2": "Implementation of the item collection (loot) system in the dungeon.",
    "project.bloody.c3": "Development of multiple gameplay checks to solidify the overall game loop.",

    "project.rumble.role": "Gameplay Developer",
    "project.rumble.team": "Unspecified",
    "project.rumble.duration": "Winter WonderJam 2025",
    "project.rumble.context": "You play as a brother and sister fighting with their toys to take control of the room. Project created during the Winter WonderJam 2025 on the theme \"Borders\". We had to respect 3 style constraints: \"A point for me\" (Arcade Genre), \"Survive another day\" (Survival Element), and \"My..Friend?\" (Your ally is also your enemy).",
    "project.rumble.c1": "Gameplay development for the 2 players.",
    "project.rumble.c2": "Programming of \"World Event\" mechanics affecting the match.",

    "project.critter.role": "Developer",
    "project.critter.team": "16 people",
    "project.critter.duration": "Bachelor's Final Project (Video Game Workshop)",
    "project.critter.context": "Play as a squirrel ready to do anything to protect its precious acorn from a horde of hungry monsters... Project created during my last semester of the video game development bachelor's degree (UQAC), as part of the Video Game Workshop course. We collaborated with the NAD (art school affiliated with UQAC) with a total team of 16 people.",
    "project.critter.c1": "Development of the skunk's movement.",
    "project.critter.c2": "Debugging movement and various features, including the rail system.",
    "project.critter.c3": "Creation of the trail mechanic.",
    "project.critter.c4": "Implementation of the food health system.",

    "project.stake.role": "Game Designer & Support",
    "project.stake.team": "7 people",
    "project.stake.duration": "Fall WonderJam (Theme: COUNTERFEIT)",
    "project.stake.context": "One Last Stake was created during the Fall WonderJam on the theme \"COUNTERFEIT\". The game is a mix of a card game inspired by classic War, integrated into a rogue-lite structure. We had 3 imposed styles to respect: New Perspective, Start Over...Again... (Rogue Lite element), and Cards on the table.",
    "project.stake.c1": "Role of Game Designer and support within the team.",
    "project.stake.c2": "Creation and design of the various card effects.",
    "project.stake.c3": "Help on the Game Design of the game loop and balancing.",
